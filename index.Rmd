...
link-citations: yes
github-repo: bfschaffner/bookdown-stata
---
...
The tutorials included here make use of the Stata statistical software (Stata 14). However, there is a parallel packet available for R users available in PDF form which can be found online [here](http://www.miacosta.com/blog).
...
![](/Images/alpha_factor_scatter.png)
